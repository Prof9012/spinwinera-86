...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-602f835f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-602f835f');}
...
var brandEl=document.querySelector('.rl-brand-602f835f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
